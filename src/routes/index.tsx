...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Pic Your Insurance — Nandan Kumar Pernaje · IRDAI-certified POSP advisor" },
      {
        name: "description",
        content:
          "IRDAI-certified Point of Sales Person Nandan Kumar Pernaje (POS 582239) helps you pick bike, car, bus, auto & health insurance online — from every major insurer, at the lowest price.",
      },
      { property: "og:title", content: "Pic Your Insurance — Nandan Kumar Pernaje" },
      {
        property: "og:description",
        content: "IRDAI-certified online insurance advisor in Dakshina Kannada. WhatsApp +91 89715 42643.",
      },
    ],
  }),
  component: Home,
